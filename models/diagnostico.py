...
class Diagnosticos():
    ...
    def init_preguntas(self):
        preguntas = [
            ...
            {"id": "_3_2", "Pregunta":"3.2 ¿Posee dispositivos de salida? (Impresoras, Parlantes)","id_categoria":3},
            ...
            {"id": "_4_3", "Pregunta":"4.3 ¿Lleva un registro de sus inventarios? (Si es de servicio elegir N/A)","id_categoria":4},
            ...
            {"id": "_4_7", "Pregunta":"4.7 ¿Lleva registro detallado de sus gastos?","id_categoria":4},
            ...
            {"id": "_5_2", "Pregunta":"5.2 ¿El proceso de elaboración sus productos esta estandarizada? (Si es de servicio elegir N/A)","id_categoria":5},
            {"id": "_5_3", "Pregunta":"5.3 ¿Cuenta con una agenda de contacto de sus proveedores?","id_categoria":5},
            {"id": "_5_4", "Pregunta":"5.4 ¿Conoce los precios de compra y traslados de las materias primas y otros materiales?","id_categoria":5},
            ...
            {"id": "_5_10", "Pregunta":"5.10 ¿Conoce cuál es el tipo de envase o empaque apropiado para el tipo de producto que elabora? (Si es de servicio elegir N/A)","id_categoria":5},
